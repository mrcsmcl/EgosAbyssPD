  ...
  const rooms = [
    {
      ...
      dante: 'Limbo',
      image: getAssetPath('/room-01-shadows-veil.jpg'),
    ...
    },
    {
      ...
      freud: 'Ideal do Ego',
      dante: 'Gula',
      image: getAssetPath('/room-02-narcissus-mirror.jpg'),
    ...
    },
    {
      ...
      dante: 'Traição',
      image: getAssetPath('/room-03-oedipus-complex.jpg'),
    ...
    },
    {
      ...
      dante: 'Peso',
      image: getAssetPath('/room-04-repression-weight.jpg'),
    ...
    },
    {
      ...
      dante: 'Purgatório',
      image: getAssetPath('/room-05-sublimation-ascent.jpg'),
    ...
    },
    {
      ...
      freud: 'Estagnação',
      dante: 'Inveja',
      image: getAssetPath('/room-06-fixation-stasis.jpg'),
    ...
    },
    {
      ...
      freud: 'Regressão',
      dante: 'Luxúria',
      image: getAssetPath('/room-07-regression-retreat.jpg'),
    ...
    },
    {
      ...
      dante: 'Desespero',
      image: getAssetPath('/room-08-thanatos-embrace.jpg'),
    ...
    },
    {
      ...
      dante: 'Centro',
      image: getAssetPath('/room-09-ego-last-stand.jpg'),
